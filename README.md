...
* **Expected Techniques (from the threat actor perspective):** PowerShell execution, network scanning, potential persistence mechanisms (e.g., scheduled tasks, registry modifications).
